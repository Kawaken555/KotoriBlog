---
title: "利用規約"
date: 2025-04-28T06:48:28Z # ファイル作成時の日付を仮置き
draft: false # 公開する場合は false に変更
---

# 利用規約

この利用規約（以下，「本規約」といいます。）は，Kawaken555（以下，「当方」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
...
3.  利用登録完了後であっても，ユーザーが前項各号のいずれかに該当することが判明した場合，当方は事前の通知なく当該利用登録を取り消し，または削除することができるものとします。
